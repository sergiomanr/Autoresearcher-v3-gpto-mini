...
def main():
    ...
    while True:
        ...
        prompt = (
            ...
            "Read 'exito.txt' to see what ideas were successful. Use this to determine what 'phase' of the project we are in. "
            "Your goal is to DIVERSIFY the feature engineering. Do not just fixate on highly complex categorical interactions every time. "
            "Rotate through different strategies. Implement ONE new feature or pipeline step from the following categories: "
            "1. Simple transformations (e.g., log-transforming highly skewed numeric columns, mathematical combinations like Total Area). "
            "2. Binning or discretizing continuous variables. "
            "3. Creative missing value imputation (e.g., imputing based on neighborhood or building type). "
            "4. Advanced categorical encodings (target encoding, frequency encoding). "
            "5. Logical multi-variable interactions (e.g., Size * Quality / Age). "
            "Do not over-engineer if simple baseline features (like handling missing values or basic combinations) haven't been secured yet. "
            "CRITICAL RULES: "
